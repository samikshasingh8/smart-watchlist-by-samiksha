...
- Source of truth precedence: live fetch > cached value > nothing. We don't
  ...
  not necessary at this scale, and out of scope for 24 hours.
...
- **Portfolio snapshot**: rule-based sector concentration + directional
  alignment across the watchlist. Deliberately descriptive, not prescriptive
  — it never recommends what to buy, since that edges into investment advice
...
- **ML-based personalized recommendations** — the original idea behind the
  portfolio snapshot feature. Needs training data and time we don't have in
  24 hours, and "what should I buy" edges into investment-advice territory
